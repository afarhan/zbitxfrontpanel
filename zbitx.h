...
/* messages sent to the control function of the field */
#define FIELD_METHOD_INIT 0
#define FIELD_METHOD_DRAW 1		
#define FIELD_METHOD_INPUT 2	//inputs given by the user (interface)
#define FIELD_METHOD_UPDATE 3 //updates the field with str in ptr (from the radio)
#define FIELD_METHOD_CLEAR 4
/* events generated by the fields */
#define FIELD_NOTIFY_SELECT 1
...
struct field {
  ...
  char value[FIELD_TEXT_MAX_LENGTH];
	char selection[128];
	int (*fn)(struct field *f, int method, void *ptr)=NULL;
  bool is_visible;
  bool redraw;
...
int listbox_fn(struct field *f, int method, void *ptr);
